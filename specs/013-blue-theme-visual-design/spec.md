...
- **FR-010**: The System Admin Portal's navigation/header MUST carry a visually distinct "platform-wide" treatment (e.g., a distinct header color/label) that differentiates it from the Tenant Admin & Staff App's company-scoped screens, even though both share the same base palette and typography.
